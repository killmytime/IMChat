...
public class MainActivity extends BaseActivity
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if (isFirst){
            String privateKey=intent.getStringExtra("masterPrivateKey");
            String username=intent.getStringExtra("masterName");
            boolean status=intent.getBooleanExtra("masterStatus",false);
            pref=getSharedPreferences("loginStaus",MODE_PRIVATE);
            editor=pref.edit();
            editor.putString("privateKey",privateKey);
            editor.putString("username",username);
            editor.putBoolean("isOnline",status);
